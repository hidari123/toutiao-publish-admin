  ...
  <div>
    <el-card class="box-card">
      ...
      <!--
        ...
        3、给表格列绑定要渲染的数据字段
       -->
      <el-table :data="articles" class="table-list">
...
<script>
import { getArticles, updateArticleStatus } from "@/api/article.js";
export default {
  ...
  methods: {
    ...
    onStatusChange(article) {
      ...
      // 请求提交修改
      updateArticleStatus(article.id.toString(), article.comment_status).then(
        (res) => {
          // 启用 switch
          article.statusDisabled = false;
          this.$message({
